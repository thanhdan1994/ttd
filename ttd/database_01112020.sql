...
INSERT INTO `like` VALUES (355,'App\\Product',55,41,2,'2020-10-31 14:18:21','2020-10-31 14:18:21'),(356,'App\\Product',54,41,1,'2020-10-31 16:21:52','2020-10-31 16:21:52');
...
INSERT INTO `notifications` VALUES (68,'App\\Product',40,43,41,2,'/tom-hum-bong-la-gan/40',0,'2020-10-24 09:23:19','2020-10-24 09:23:19'),(69,'App\\Product',49,41,41,2,'/iphone-12-pro-max-128gb-gold/49',0,'2020-10-25 07:54:58','2020-10-25 07:54:58'),(70,'App\\Product',55,41,41,2,'/iphone-12-mini-2/55',0,'2020-10-26 14:30:10','2020-10-26 14:30:10'),(71,'App\\Comment',32,41,41,1,NULL,0,'2020-10-31 12:08:06','2020-10-31 12:08:06'),(72,'App\\Product',54,41,41,2,'/iphone-12-mini/54',0,'2020-10-31 16:21:52','2020-10-31 16:21:52');
...
INSERT INTO `product_service` VALUES (22,1),(22,2),(22,3),(24,1),(24,2),(24,3),(25,1),(25,2),(25,3),(28,2),(28,3),(27,1),(27,2),(27,3),(30,1),(30,2),(31,1),(32,1),(32,3),(33,3),(33,2),(34,2),(34,3),(36,2),(36,3),(37,3),(37,1),(38,2),(38,3),(39,1),(39,2),(40,2),(40,3),(42,2),(42,3),(43,3),(54,1),(54,2),(55,2),(55,1);
...
CREATE TABLE `products` (
  ...
  `lat` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `long` tinytext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
INSERT INTO `read_notification_at` VALUES (41,'2020-10-31 12:37:46'),(42,'2020-10-31 12:37:46'),(43,'2020-10-31 12:37:46');
...
CREATE TABLE `social_accounts` (
  ...
  `social_provider` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `role` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'checker',
...
-- Dump completed on 2020-11-01  7:48:02
